...
// make sure joomla stuff is already loaded.
define('_JEXEC', 1);
define('JPATH_BASE', dirname(dirname(dirname(dirname(dirname(__DIR__))))));
require_once(JPATH_BASE . '/includes/defines.php');
require_once(JPATH_BASE . '/includes/framework.php');

if ($_COOKIE['lpsaml_login_context'] == 'core.login.admin')
